...
// NewCacertsParams creates a new CacertsParams object
// with the default values initialized.
func NewCacertsParams() *CacertsParams {

	return &CacertsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCacertsParamsWithTimeout creates a new CacertsParams object
...
// NewCacertsParamsWithContext creates a new CacertsParams object
...
// NewCacertsParamsWithHTTPClient creates a new CacertsParams object
...
/*CacertsParams contains all the parameters to send to the API endpoint
for the cacerts operation typically these are written to a http.Request
*/
